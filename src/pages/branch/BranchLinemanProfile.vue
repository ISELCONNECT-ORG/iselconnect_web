<!-- src/pages/branch/BranchLinemanProfile.vue -->
<template>
  <div class="dashboard-root">
    ...
    <main class="content">
      ...
      <header class="hero-banner detail-hero">
        <router-link to="/branch/linemen" class="back-link">
        ...
        <div class="section-container">
          ...
          <div class="info-grid">
            ...
            <div class="info-item">
              ...
              <p>{{ lineman.users.iselco_branch?.branch_name || 'Branch' }}</p>
            </div>
          </div>
        </div>
...
const fetchProfile = async () => {
  ...
  const { data: emp, error } = await supabase
    .from('employees')
    .select(
      `user_id, employee_id_no, is_available, users(first_name, last_name, email, mobile_number, branch_id, iselco_branch(branch_name))`,
    )
    .eq('id', linemanId)
