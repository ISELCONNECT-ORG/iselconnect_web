            ...
            <div v-if="step === 2" class="step-content">
              ...
              <div class="grid-3">
                <div>
                  ...
                  <input v-model="form.firstName" class="std-input" />
                </div>
                <div>
                  <label>MIDDLE NAME</label>
                  <input v-model="form.middleName" class="std-input" />
                </div>
                <div>
                  <label>LAST NAME</label>
                  <input v-model="form.lastName" class="std-input" />
                </div>
              </div>
              <div class="grid-2" style="margin-top: 16px">
                <div>
                  <label>EMAIL</label>
                  <input v-model="form.email" type="email" class="std-input" />
                </div>
                <div>
                  <label>CONTACT NUMBER</label>
                  <input v-model="form.mobileNumber" class="std-input" />
                </div>
              </div>
              <div class="grid-3" style="margin-top: 16px">
                <div>
                  <label>PUROK</label>
                  <input v-model="form.purok" class="std-input" />
                </div>
                <div>
                  <label>BARANGAY</label>
                  <input v-model="form.barangay" class="std-input" />
                </div>
                <div>
                  <label>MUNICIPALITY</label>
                  <input v-model="form.municipality" class="std-input" />
                </div>
              </div>
            </div>
...
try {
  import('@/utils/notifications.js').then((module) => {
    if (module.sendNotification) sendNotification = module.sendNotification
  })
} catch (e) {
  console.warn('Notifications module not found, continuing without notifications.')
}
